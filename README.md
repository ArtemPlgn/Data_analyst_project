...
| [02. Анализ топа фильмов](https://github.com/ArtemPlgn/Data_analyst_project/tree/main/top_movies)|Провести статистический анализ данных. Найти признаки почему одни фильмы зарабатывают больше, чем другие.|Pandas, Numpy, Seaborn, Matplotlib, SQLite|
