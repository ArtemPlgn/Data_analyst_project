...
| [02. Анализ топа фильмов](https://github.com/ArtemPlgn/Data_analyst_project/tree/main/top_movies)|Исследовательский анализ данных. Статистический анализ данных. Найти закономерность по которой составляется топ.|Pandas, Numpy, Seaborn, Matplotlib, SQLite|
